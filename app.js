const { Component } = Inferno;
const { createElement: h } = Inferno;
...
class CocktailViewer extends Component {
  ...
  render() {
    ...
    return h(
      'div',
      { className: 'container' },
      h('h1', { className: 'title' }, '🍹 Random Cocktail'),
      h('p', { className: 'subtitle' }, 'TheCocktailDB API'),

      loading
        ? h('div', { className: 'loading' }, 'Carregando drink...')
        : cocktail &&
            h(
              'div',
              ...
              h('h2', { className: 'cocktail-name' }, cocktail.strDrink),
              ...
              h(
                ...
                h(
                  'div',
                  { className: 'info-item' },
                  h('span', { className: 'label' }, 'Categoria:'),
                  h('span', null, cocktail.strCategory)
                ),
                h(
                  'div',
                  { className: 'info-item' },
                  h('span', { className: 'label' }, 'Tipo:'),
                  h('span', null, cocktail.strAlcoholic)
                ),
                h(
                  'div',
                  { className: 'info-item' },
                  h('span', { className: 'label' }, 'Taça:'),
...
Inferno.render(h(CocktailViewer), document.getElementById('app'));
